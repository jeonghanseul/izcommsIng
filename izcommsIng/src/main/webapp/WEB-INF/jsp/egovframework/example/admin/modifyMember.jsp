...
// 		document.form.roadFullAddr.value = roadFullAddr;
		document.memberModifyForm.address.value = roadAddrPart1;
// 		document.form.roadAddrPart2.value = roadAddrPart2;
		document.memberModifyForm.detailAddress.value = addrDetail;
...
<validator:javascript formName="memberModifyForm" staticJavascript="false" xhtml="true" cdata="false"/>
</head>
<body>
	<jsp:include page="./head.jsp"/>
	<div>
		<form:form commandName="memberVO" name="memberModifyForm" action="./modifyMemberDo.do" method="POST" onsubmit="return validateMemberModifyForm(this)">
			<table>
				<colgroup>
					<col />
				</colgroup>
